...
gpt_instance_ctrl_t system_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t system_timer_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t system_timer_extend =
{
...
#if 0
    .p_pwm_cfg                   = &system_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t system_timer_cfg =
{
    ...
    .channel             = 3,
    .p_callback          = system_timer_callback,
...
const timer_instance_t system_timer =
{
    .p_ctrl        = &system_timer_ctrl,
    .p_cfg         = &system_timer_cfg,
...
gpt_instance_ctrl_t oled_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t oled_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t oled_timer_extend =
{
    .gtioca = { .output_enabled = false,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &oled_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t oled_timer_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
    /* Actual period: 0.1 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x989680, .duty_cycle_counts = 0x4c4b40, .source_div = (timer_source_div_t)0,
    .channel             = 2,
    .p_callback          = oled_timer_callback,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Instance structure to use this module. */
const timer_instance_t oled_timer =
{
    .p_ctrl        = &oled_timer_ctrl,
    .p_cfg         = &oled_timer_cfg,
    .p_api         = &g_timer_on_gpt
};
...
dtc_instance_ctrl_t current_adc_transfer_ctrl;

#if (1 == 1)
transfer_info_t current_adc_transfer_info DTC_TRANSFER_INFO_ALIGNMENT =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
#elif (1 > 1)
/* User is responsible to initialize the array. */
transfer_info_t current_adc_transfer_info[1] DTC_TRANSFER_INFO_ALIGNMENT;
#else
/* User must call api::reconfigure before enable DTC transfer. */
#endif

const dtc_extended_cfg_t current_adc_transfer_cfg_extend =
{
    .activation_source   = VECTOR_NUMBER_ADC0_SCAN_END,
};

const transfer_cfg_t current_adc_transfer_cfg =
{
#if (1 == 1)
    .p_info              = &current_adc_transfer_info,
#elif (1 > 1)
    .p_info              = current_adc_transfer_info,
#else
    .p_info = NULL,
#endif
    .p_extend            = &current_adc_transfer_cfg_extend,
};

/* Instance structure to use this module. */
const transfer_instance_t current_adc_transfer =
{
    .p_ctrl        = &current_adc_transfer_ctrl,
    .p_cfg         = &current_adc_transfer_cfg,
    .p_api         = &g_transfer_on_dtc
};
...
gpt_instance_ctrl_t adc_timer_ctrl;
#if 1
const gpt_extended_pwm_cfg_t adc_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t adc_timer_extend =
{
    .gtioca = { .output_enabled = false,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 1
    .p_pwm_cfg                   = &adc_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
    ...
    .gtior_setting.gtior_b.nfaen  = ((uint32_t) GPT_CAPTURE_FILTER_NONE & 1U),
    .gtior_setting.gtior_b.nfcsa  = ((uint32_t) GPT_CAPTURE_FILTER_NONE >> 1U),
    .gtior_setting.gtior_b.gtiob  = (0U << 4U) | (0U << 2U) | (3U << 0U),
    .gtior_setting.gtior_b.obdflt = (uint32_t) GPT_PIN_LEVEL_LOW,
    .gtior_setting.gtior_b.obhld  = 0U,
    .gtior_setting.gtior_b.obe    = (uint32_t) false,
    .gtior_setting.gtior_b.obdf   = (uint32_t) GPT_GTIOC_DISABLE_PROHIBITED,
...
const timer_cfg_t adc_timer_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
...
/* Instance structure to use this module. */
const timer_instance_t adc_timer =
{
    .p_ctrl        = &adc_timer_ctrl,
    .p_cfg         = &adc_timer_cfg,
    .p_api         = &g_timer_on_gpt
};
